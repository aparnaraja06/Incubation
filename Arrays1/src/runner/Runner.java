...
public static void main(String[] args)
{
	...
	case 1:
	{
	    ...
	    try
	    {
	    	int[] arr=reader.smallerNum(int_arr);
	    	for(int i=0;i<num;i++)
	    	{
	...
	case 5:
	{
	    ...
	    try
	    {
	    	int result=reader.majorityElement(num, int_arr);
	    	System.out.println(result);
	    }
	    catch(CustomException e)
	    {
	...
	case 6:
	{
	    ...
	    try
	    {
	    	int result=reader.searchElement(num, int_arr, key);
	    	System.out.println(result);
	    }
	    catch(CustomException e)
	    {
	...
	case 10:
	{
		...
		try
	    {
			int result=reader.minDifference(int_arr);
			System.out.println(result);
	    }
		catch(CustomException e)
	    {
	...
	case 14:
	{
		...
		try
	    {
			int result=reader.nonRepeatingNumber(int_arr);
			System.out.println(result);
	    }
		catch(CustomException e)
	    {
